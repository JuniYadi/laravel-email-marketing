...
new class extends Component
{
    ...
    public function importContacts(): void
    {
        ...
        $path = $validated['csvFile']->store('imports/contacts', $disk);

        ImportContactsFromCsv::dispatch(
            path: $path,
            disk: $disk,
            selectedGroupIds: $validated['selectedGroupIds'] ?? [],
        );

        $this->importedContactsCount = 0;
        $this->reset('csvFile');
        $this->showImportModal = false;
        $this->dispatch('contacts-import-queued');
    }

<section class="w-full">
    ...
    >
        ...
        <form wire:submit="saveTemplate" class="grid gap-6 xl:grid-cols-[340px_1fr]">
            <div class="space-y-6 rounded-xl border border-zinc-200 p-5 dark:border-zinc-700">
                <div>
                    ...
                    <flux:text class="mt-1 text-sm">{{ __('Configure metadata and global theme.') }}</flux:text>
                </div>
                ...
                <flux:radio.group wire:model.live="mode" :label="__('Mode')" variant="segmented">
                ...
                @if ($mode === 'visual')
                    ...
                    <div class="space-y-4">
                        <flux:heading size="lg">{{ __('Starter') }}</flux:heading>
                    ...
                    <div class="space-y-3">
                        <flux:heading size="lg">{{ __('Elements') }}</flux:heading>
            ...
            <div class="space-y-5 rounded-xl border border-zinc-200 p-5 dark:border-zinc-700">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <flux:radio.group wire:model.live="workspaceTab" variant="segmented">
